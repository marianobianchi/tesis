...
\begin{frame}{}
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[scale=0.3]{img/escena_con_objetos.jpg}
    \end{figure}
\end{frame}
%--- Next Frame ---%
...
\begin{frame}
    \textbf{Seguimiento de objetos en secuencias de imágenes \fcolorbox{red}{white}{RGB}-D}
...
\begin{frame}{}
    \textbf{Seguimiento de objetos en secuencias de imágenes RGB-\fcolorbox{red}{white}{D}}
