...
\begin{table}
	...
	Objeto & & overlap STD & & &\\
    \hline
    Taza   & 49.12      & 18.74       & 91.67             & 0                & 2\footnote{NO TIENE SENTIDO QUE HAYA FALSOS NEGATIVOS PORQUE SI NO SE SIGUE SE TIENE QUE ENCONTRAR PORQUE LA DETECCION ES IDEAL. VER EL ANALISIS. VER SI ESTO SUCEDE PORQUE FALLO EL FILTRO DE PUNTOS DE LA ESCENA LUEGO DE LA DETECCION}\\
    \hline
...
En la tabla \ref{tabla_d} se puede ver que el tracking se comporta de manera más regular que el algoritmo de RGB. Los tres ejemplos tienen una alta taza de seguimiento, en particular, todas por encima del 90\%. En los casos de la taza y la gorra además se tiene un buen balance entre el promedio de solapamiento del área encontrada y el área reportada por el ground truth y el desvío estándar. 
