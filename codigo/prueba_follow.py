...
print(("Top should be 186, but is" + str(topbottom_leftright.first.first)))
print(("Bottom should be 295, but is" + str(topbottom_leftright.first.second)))
print(("Left should be 95, but is" + str(topbottom_leftright.second.first)))
print(("Right should be 221, but is" + str(topbottom_leftright.second.second)))
