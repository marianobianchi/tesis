...
from seguidores import CombinedFollowerWithStaticDetection



def correr_con_depth_como_principal(img_provider, scenename, scenenumber, objname, objnum):
    ...
    for i in range(3):
        ...
        follower = CombinedFollowerWithStaticDetection(
...
def correr_con_rgb_como_principal(img_provider, scenename, scenenumber, objname, objnum):
    # Set alignment detection parameters values
    ap_defaults = APDefaults()
    ap_defaults.leaf = 0.005
    ap_defaults.max_ransac_iters = 120
