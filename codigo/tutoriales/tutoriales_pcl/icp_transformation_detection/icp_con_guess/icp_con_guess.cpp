...
int main (int argc, char** argv)
{
    ...
    **/
    ...
    Eigen::Matrix4f only_rotation_r = r;

    // Define a translation of 1 meter on the x axis.
    r (0,3) = 1;
    ...
    * */
    ...
    pcl::transformPointCloud (*source_cloud, *transformed_source_cloud, only_rotation_r);
    // Print the transformation
    std::cout << "Guess transformation: " << std::endl;
    std::cout << only_rotation_r << std::endl;
    ...
    icp.setInputSource(transformed_source_cloud);
